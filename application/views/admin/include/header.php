  ...
  <ul class="nav-header pull-right">
    <li>
      <div class="btn-group">
        ...
        <?php /*?><img src="<?php // echo base_url();?>assets/img/avatars/avatar10.jpg" ><?php */?>
        ...
        <ul class="dropdown-menu dropdown-menu-right">
          ...
          <li> <a tabindex="-1" href="<?php echo base_url('login/logout'); ?>"> <i class="si si-logout pull-right"></i>Log out </a> </li>
        </ul>
      </div>
    </li>
    <li> 
