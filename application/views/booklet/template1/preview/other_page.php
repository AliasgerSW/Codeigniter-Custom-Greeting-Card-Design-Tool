<div class="front_right_book other-frm">
  <div class="page_header_preview" id="page_header_preview" <?php (empty($isheader) ? 'style="display:none"' : ''); ?>>
    <h4 class="book_title" id="page_heading_preview"><?php echo $page_heading; ?></h4>
  </div>
  <span class="clear"></span> <br>
  <h3 class="book_title" id="heading_preview"><?php echo $heading; ?></h3>
